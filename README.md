[![Go Report Card](https://goreportcard.com/badge/github.com/Acolyte/supervisord)](https://goreportcard.com/report/github.com/Acolyte/supervisord)
...
![alt text](https://github.com/Acolyte/supervisord/blob/master/go_supervisord_gui.png)
...
```Dockerfile
FROM debian:latest
COPY --from=Acolyte/supervisord:latest /usr/local/bin/supervisord /usr/local/bin/supervisord
